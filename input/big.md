...
This study guide will help you pass the newer AWS Certified Solutions Architect - Associate exam. In order to pass, reference this guide while working through the material in the following steps:
  ...
  1. Stephane Maarek's [Ultimate AWS Certified Solutions Architect Associate 2020 course](https://www.udemy.com/course/aws-certified-solutions-architect-associate-saa-c02/) or A Cloud Guru's [AWS Certified Solutions Architect Associate 2020 course](https://acloud.guru/learn/aws-certified-solutions-architect-associate) 
  ...
  4. Andrew Brown's [AWS Certified Solutions Architect - Associate 2020 (PASS THE EXAM!) | Ad-Free Cours](https://www.youtube.com/watch?v=Ia-UEYYR44s)
] 

Go through the course you purchased as part of Step 1. twice. The first time should be a runthrough to introduce yourself to new AWS concepts and exam details. Jot down the services that confuse you and start with their FAQs as part of Step 2. You should then go through Step 1. once more, but this time as a deep dive. Be sure to pause frequently so that you research concepts that aren't perfectly clear, take notes, and experiment on the AWS console. Once you've completed Step 1. and Step 2., begin testing yourself with the Tutorial Dojo exams. Take the time to read the explanations for the questions that you get wrong. During the days leading up to your exam, go through Andrew Brown's YouTube video as the final step just as a refresher. If at any point you find yourself feeling uncertain of your progress and in need of more time, you can postpone your AWS exam date. This can be done twice. Finally, be sure to keep up on the ongoing discussions in [r/AWSCertifications](https://old.reddit.com/r/AWSCertifications/). There you will find more general information regarding exam tips, study material, and advice from other exam takers.

*Note*: When experimenting on your AWS account, be sure to understand what is [free](https://aws.amazon.com/free/?all-free-tier.sort-by=item.additionalFields.SortRank&all-free-tier.sort-order=asc) and what isn't. Relevant Free Tier FAQs can be found [here](https://aws.amazon.com/free/free-tier-faqs/).
...
## Table of Contents
1. [Introduction](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#introduction)

2. [Identity Access Management (IAM)](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#identity-access-management-iam)

3. [Simple Storage Service (S3)](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#simple-storage-service-s3)

4. [CloudFront](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#cloudfront)

5. [Snowball](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#snowball)

6. [Storage Gateway](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#storage-gateway)

7. [Elastic Compute Cloud (EC2)](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#elastic-compute-cloud-ec2)

8. [Elastic Block Store (EBS)](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#elastic-block-store-ebs)

9. [Elastic Network Interfaces (ENI)](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#elastic-network-interfaces-eni)

10. [Security Groups](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#security-groups)

11. [Web Application Firewall (WAF)](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#web-application-firewall-waf)

12. [CloudWatch](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#cloudwatch)

13. [CloudTrail](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#cloudtrail)

14. [Elastic File System (EFS)](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#elastic-file-system-efs)

15. [Amazon FSx for Windows](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#amazon-fsx-for-windows)

16. [Amazon FSx for Lustre](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#amazon-fsx-for-lustre)

17. [Relational Database Service (RDS)](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#relational-database-service-rds)

18. [Aurora](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#aurora)

19. [DynamoDB](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#dynamodb)

20. [Redshift](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#redshift)

21. [ElastiCache](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#elasticache)

22. [Route53](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#route53)

23. [Elastic Load Balancers (ELB)](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#elastic-load-balancers-elb)

24. [Auto Scaling](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#auto-scaling)

25. [Virtual Private Cloud (VPC)](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#virtual-private-cloud-vpc)

26. [Simple Queuing Service (SQS)](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#simple-queuing-service-sqs)

27. [Simple Workflow Service (SWF)](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#simple-workflow-service-swf)

28. [Simple Notification Service (SNS)](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#simple-notification-service-sns)

29. [Kinesis ](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#kinesis)

30. [Lambda ](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#lambda)

31. [API Gateway ](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#api-gateway)

32. [CloudFormation ](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#cloudformation)

33. [ElasticBeanstalk](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#cloudformation)

34. [AWS Organizations](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#aws-organizations) 

35. [Miscellaneous](https://github.com/keenanromain/AWS-SAA-C02-Study-Guide#miscellaneous)
